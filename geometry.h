...
public:
	...
	{};
	bool intersection(const Vec3<T>& source_point, const Vec3<T>& ray_direction, Vec3<T>& intersection_point);
};
...
template<typename T>
bool Sphere<T>::intersection(const Vec3<T>& source_point, const Vec3<T>& ray_direction, Vec3<T>& intersection_point) {
